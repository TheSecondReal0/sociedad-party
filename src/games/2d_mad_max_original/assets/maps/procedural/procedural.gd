...
var wall = load("res://games/2d_mad_max_original/assets/maps/procedural/wall.tscn")

var increment = 5

var mapGenerator_script: Script = load("res://games/2d_mad_max_original/autoload/mapGenerator.gd")
