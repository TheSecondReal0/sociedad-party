...
# warning-ignore:return_value_discarded
	UIManager.connect("open_ui_signal", Callable(self, "open_ui"))
# warning-ignore:return_value_discarded
	UIManager.connect("close_ui_signal", Callable(self, "close_ui"))
# warning-ignore:return_value_discarded
	UIManager.connect("instance_ui_signal", Callable(self, "instance_ui"))
# warning-ignore:return_value_discarded
...
#		return
	if not file_exists(ui_path):
		return
	var new_ui = load(ui_path).instantiate()
